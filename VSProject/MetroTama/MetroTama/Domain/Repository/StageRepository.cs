            ...
            var stage = new Stage
                {
                    StageId = 1,
                    Name = "Egg",
                    DirtyTime = new TimeSpan(0, 0, 0, 3, 0),
                    EnergyTime = new TimeSpan(0, 0, 0, 2, 0),
                    FunTime = new TimeSpan(0, 0, 0, 10, 0),
                    HealtTime = new TimeSpan(0, 0, 0, 3, 0),
                    PoopTime = new TimeSpan(0, 0, 0, 3, 0),
                    StudyTime = new TimeSpan(0, 0, 0, 10, 0),
                    EatTime = new TimeSpan(0, 0, 0, 2, 0)
                };
