...
namespace MetroTama.Domain.Repository
{
    class StageRepository
    {
        public Stage GetStage() {
            ...
            stage.DirtyTime = new TimeSpan(0, 0, 0, 30, 0);
            stage.EnergyTime = new TimeSpan(0, 0, 0, 20, 0);
            stage.FunTime = new TimeSpan(0, 0, 1, 0, 0);
            stage.HealtTime = new TimeSpan(0, 0, 1, 0, 0);
            stage.PoopTime = new TimeSpan(0, 0, 2, 30, 0);
            stage.StudyTime = new TimeSpan(0, 0, 2, 0, 0);
            stage.EatTime = new TimeSpan(0, 0, 0, 15, 0);
            return stage;
        }
    }
}
